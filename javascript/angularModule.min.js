...
app.service('getScrollTopService', function () {
  ...
  self.returnScrollTop = function (scrollTop) {
    ...
    if (scrollTop > 500) {
      self.imagesBool = true;  //console.log(self.imagesBool);
    } else {
      self.imagesBool = false;  //console.log(self.imagesBool);
    }
  };
});
app.controller('workController', [
  ...
  '$log',
  'getScrollTopService',
  function ($scope, $log, getScrollTopService) {
    var self = this;
    ...
    self.openModal = function (index) {
      var width = $(window).innerWidth();
      var $colClicked = $($('.imgCol')[index]);
      //self current modal is an index
      var offset = $colClicked.find('#modal').position().top;
      offset = offset + 'px';
      self.modalActive = true;
      //THIS CHANGES THE MODALS TO SHOW
    ...
    self.imgArray = [
      {
        src: 'apartmentShot.png',
        alt: 'APP',
        title: 'apartmentShark',
        message: 'web application to track and manage your apartment hunt',
        href: 'http://davidgoodman.club/apartmentShark',
        features: '',
        git: 'https://github.com/Deg5112/Final_Project.git',
        modalText1: 'The final project of LearningFuze Web Development Bootcamp is supposed to a be a project that encompasses everything from front to backend skills, as well as an application that is ever-evolving and something that solved a problem. I call this app, apartmentShark',
      ...
      },
      {
        ...
        href: 'http://deg5112.github.io/Mboutique_Project/',
        features: '',
        git: 'https://github.com/Deg5112/Mboutique_Project.git',
        modalText1: 'This was the first Project of LearningFuze bootcamp.',
        modalText2: 'The idea was to code out and emulate a small business website, after being given the wireframe from a design team.'
      },
      {
        src: 'memorymatch.png',
        alt: 'GAME',
        ...
        href: 'http://deg5112.github.io/Memory_Match_Game_Project/',
        features: '',
      ...
      },
      {
        ...
        href: 'http://davidgoodman.club/Student_Grade_Table_Project/',
        features: '',
        git: 'https://github.com/Deg5112/Student_Grade_Table_Project.git',
        modalText1: 'This project is an app that resembles the functionality of a grade table application that an administrator or teach would have access too.',
        modalText2: 'The first part of this project was to build the layout in Bootstrap, and then make the AJAX calls the backend which our senior developers wrote the PHP scripts that fed us back responses.'
      },
      {
        src: 'calculator.png',
        alt: 'APP',
        ...
        href: 'http://deg5112.github.io/Calculator_Project/',
        features: '',
        git: 'https://github.com/Deg5112/Calculator_Project.git',
        modalText1: 'What appears to be just a calculator,was actually the most difficult project, as well as one of my favorite projects I got to work.',
        modalText2: 'That is because from beginning to end, I was immersed in logic, which is my more favorite part about javascript programming, is reading through logic and making a hypothesis about what should happen, testing it out, and potentially debugging what I need to do to fix the problem.'
      },
      {
        src: 'tictactoe.png',
        alt: 'GAME',
        title: 'TicTacToe',
        message: 'Hack-a-thon tictactoe group project',
        href: 'http://deg5112.github.io/hacka-tictactoe-athon/',
        features: '',
        git: 'https://github.com/Deg5112/hacka-tictactoe-athon.git',
        modalText1: 'This was our first hackathon, modeled after tic tac toe.',
      ...
      },
      {
        ...
        alt: 'WEBSITE',
        title: 'Blog',
        message: 'A blog with a log-in system tied to a backend database',
        href: 'http://davidgoodman.club/Blog',
        features: '',
        git: 'https://github.com/Deg5112/Blog.git',
        modalText1: 'A project where we would build out the functionality needed for a blog. What initially started out as a group project, the Blog was a a project where I participated not only participated in developing the front as well as the backend of the blog, but acted as scrum master.',
        modalText2: 'As scrum master, I assisted with planning out the scope of the project, helped the team prioritize all features that we\'d be able to complete by the deadline, and worked with waffle.io web based task management system that integrates with github to assign out and track the teams progress during this project.'
      }
    ];
